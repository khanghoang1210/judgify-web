      ...
      <div className="flex items-center gap-20 w-full max-w-5xl relative z-10">
        ...
        <div className="hidden lg:flex flex-col flex-1 min-w-0">
          ...
          <p className="text-headline-sm text-on-surface-variant leading-relaxed max-w-xs">
            Welcome back. Pick up where you left off and keep climbing.
          </p>
        </div>
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 rounded border-outline-variant bg-surface-container-high accent-primary cursor-pointer"
                  />
