...
const SEGMENTS = [
  { key: "easy" as const, label: "Easy", color: "var(--color-tertiary)" },
  { key: "medium" as const, label: "Medium", color: "var(--color-warning)" },
  { key: "hard" as const, label: "Hard", color: "var(--color-error)" },
];
      ...
      <div className="space-y-2.5">
        {SEGMENTS.map((seg) => (
          <div key={seg.key} className="flex items-center justify-between">
            ...
            <span className="text-code-md font-medium text-on-surface font-jetbrains-mono">
